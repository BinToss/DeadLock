...
namespace DeadLock.Classes.Native
{
    /// <summary>
    /// This class contains a list of native methods that can be called by other functions
    /// </summary>
    internal sealed class NativeMethods
    {
        ...
        internal static IEnumerable<Process> FindLockingProcesses(string path)
        {
            ...
            if (res != 0) throw new Exception("An exception occured while trying to access a native method!");
            ...
            try
            {
                ...
                if (res == errorMoreData)
                {
                    ...
                    else throw new Exception("An exception occured while trying to access a native method!");
                }
                else if (res != 0) throw new UnauthorizedAccessException("DeadLock is unauthorized to access the file!");
            }
            finally
            {
                RmEndSession(handle);
        ...
        /// <summary>
        /// Show the properties dialog of a file or folder
        /// </summary>
